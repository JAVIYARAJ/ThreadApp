...
@Composable
fun AuthBottomLabel(title:String,subTitle:String,onTap:()->Unit){
    Row {
       Text(text = title, style = TextStyle(fontSize = 15.sp, fontWeight = FontWeight.Normal, color = Color.White))
       BasicText(text = subTitle,style = TextStyle(fontSize = 16.sp, fontWeight = FontWeight.Bold, color = Color.White), modifier = Modifier.clickable {
        onTap
       })
    }
}
